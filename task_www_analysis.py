# Homework - Vehicle Recovery by CISP
# CISP is a police station in Brazil
# The data is about the number of vehicles recovered by each CISP
# The data is available at: https://www.ispdados.rj.gov.br/Arquivos/BaseDPEvolucaoMensalCisp.csv
...
# Calculating central tendency, dispersion, position and outliers
try:
    ...
    # Calculating and printing central tendency measures
    ...
    # Calculating and printing dispersion measures
    ...
    # Calculating and printing position measures
